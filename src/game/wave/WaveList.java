...
// Wave 6
        ...
        for (int i = 0; i < 7; i++) {
            waveContend6.add(new FastEnemy(new Vector(250, -300 - 100 * i), gamePath.getSegments()));
        }
        for (int i = 0; i < 3; i++) {
            waveContend6.add(new TankEnemy(new Vector(250, -500 - 80 * i), gamePath.getSegments()));
        }
        for (int i = 0; i < 7; i++) {
...
// Wave 8
        ...
        for (int i = 0; i < 4; i++) {
            waveContend8.add(new TankEnemy(new Vector(250, -250 - 100 * i), gamePath.getSegments()));
        }
...
// Wave 15
        ...
        for (int i = 0; i < 3; i++) {
            ...
            waveContend15.add(new TankEnemy(new Vector(250, -350 - 50 * i), gamePath.getSegments()));
...
// Wave 17
        ...
        for (int i = 0; i < 3; i++) {
            waveContend17.add(new TankEnemy(new Vector(250, -200 - 80 * i), gamePath.getSegments()));
        }
        for (int i = 0; i < 3; i++) {
...
// Wave 21
        ...
        for (int i = 0; i < 4; i++) {
            waveContend22.add(new TankEnemy(new Vector(250, -600 - 70 * i), gamePath.getSegments()));
        }
        for (int i = 0; i < 4; i++) {
...
// Wave 29
        ...
        for (int i = 0; i < 3; i++) {
            waveContend29.add(new BossEnemy(new Vector(250, -50 - 80 * i), gamePath.getSegments()));
        }
        for (int i = 0; i < 5; i++) {
            waveContend29.add(new AntiFreezeEnemy(new Vector(250, -1000 - 70 * i), gamePath.getSegments()));
        }
        waveContend29.add(new DistractEnemy(new Vector(250, -150 - 80), gamePath.getSegments()));
        addWave(waveContend29);

// Wave 30 (Final Boss Wave)
        List<Enemy> waveContend30 = new ArrayList<>();
        for (int i = 0; i < 2; i++) {
            waveContend30.add(new BossEnemy(new Vector(250, -50 - 100 * i), gamePath.getSegments()));
        }
        for (int i = 0; i < 4; i++) {
            waveContend30.add(new RegenEnemy(new Vector(250, -700 - 70 * i), gamePath.getSegments()));
        }
        for (int i = 0; i < 6; i++) {
            waveContend30.add(new AntiFreezeEnemy(new Vector(250, -1200 - 80 * i), gamePath.getSegments()));
        }
    ...
    public void initLevel2(GamePath gamePath){
        ...
        for (int i = 0; i < 8; i++) {
            waveContend13.add(new StandartEnemy(new Vector(250, -500 - 50 * i), gamePath.getSegments()));
        }
        ...
        for (int i = 14; i <= 30; i++) {
            ...
            for (int j = 0; j < i + 6; j++) {
                waveContend.add(new StandartEnemy(new Vector(250, -50 - 50 * j/3), gamePath.getSegments()));
            }
            for (int j = 0; j < i + 4; j++) {
                waveContend.add(new FastEnemy(new Vector(250, -100 * i - 100 * j/3), gamePath.getSegments()));
            }
            for (int j = 0; j < i + 3; j++) {
                waveContend.add(new TankEnemy(new Vector(250, -100 * i - 50 * j/3), gamePath.getSegments()));
            }
            for (int j = 0; j < i + 2; j++) {
                waveContend.add(new AntiFreezeEnemy(new Vector(250, -100 * i - 90 * j/3), gamePath.getSegments()));
            }
            if (i % 5 == 0) {
